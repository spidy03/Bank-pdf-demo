const demoSteps = [
  {
    ...
    delay: 0,
    highlight: {
      x: 1000,    // Settings button x position (adjusted left)
      y: 190,    // Settings button y position (adjusted)
      width: 75,
      height: 40
    }
  },
  ...
  },
  {
    ...
    showAlert: true,  // Show alert popup
    alertText: "Let's move to Tally to check this entries"
  },
  {
    id: 27,
